...
function ReviewCard({ data }: any) {
  ...
  return (
    <div className="glide-01 w-full relative mt-10">
      <div className="overflow-hidden" data-glide-el="track">
        <div className="flex whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] touch-pan-y will-change-transform w-full h-full overflow-hidden p-2 shadow">
          {data &&
            ...
            data.map((item) => (
              <div
                className="relative flex flex-col rounded-xl w-[400px] mx-auto p-4 bg-white bg-clip-border shadow dark:bg-slate-800 dark:text-white dark:!shadow-none"
                key={item.id}
              >
                <div className="relative flex h-32 w-full rounded-xl bg-cover">
                  ...
                  />
                  <div className="absolute -bottom-12 flex ml-5 h-[80px] w-[80px] rounded-full border-[4px] border-white dark:!border-slate-800">
                    <img
                ...
                <div className="mt-14 ml-2">
                  <span className="text-sm text-gray dark:text-slate-400 xs:text-xs">
